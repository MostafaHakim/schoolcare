...
const HomeworkPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 px-3 py-4 space-y-4 
      ...
      {/* Add custom CSS for scrollbar hide and responsive adjustments */}
      <style jsx>{`
        .scrollbar-hide {
        ...
        /* Extra small devices (350px to 500px) */
